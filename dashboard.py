...
# PATH
default_results_path = 'results/single_optimization'
...
def output():
    ...
    children = dbc.Container([title_1,
                              ...
                              dbc.Col(table),
                              html.Br(),html.Br(),
                              dbc.Row([dbc.Col(statistics_1,  width={'size':6, "offset": 0}), dbc.Col(statistics_2, width={'size':6, "offset": 0})], justify="center", style={'background-color': 'Lavender'}),
...
def update_output(run_optimization, max_generations , pop_size, num_offspring, room_size, crossover_rate, mutation_rate, selected_course, new_argument, selected_selector, selected_variator, selected_replacer):
    ...
    global best_individual, fitness_list, last_selected_course, fig_fit, fig_div, df, num_run, final_schedule_path
    ...
    if triggered_id == 'run_optimization':
        ...
        kwargs['results_path'] = default_results_path+'/run_'+str(num_run)
        final_schedule_path = kwargs['results_path']+'/final_schedule.xlsx'
    ...
    if selected_course!=last_selected_course and final_schedule_path is not None:
